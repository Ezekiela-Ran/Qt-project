...
class InvoiceService:
    ...
    def save_standard_invoice(self, company_name, stat, nif, address, date_issue, date_result, product_ref, responsable, total, selected_products, selected_refs=None):
        return self.db.save_standard_invoice(company_name, stat, nif, address, date_issue, date_result, product_ref, responsable, total, selected_products, selected_refs)

    def update_standard_invoice(self, invoice_id, company_name, stat, nif, address, date_issue, date_result, product_ref, responsable, total, selected_products, selected_refs=None):
        return self.db.update_standard_invoice(invoice_id, company_name, stat, nif, address, date_issue, date_result, product_ref, responsable, total, selected_products, selected_refs)
